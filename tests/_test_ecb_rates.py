from cloud_function.ecb_exchange_rates import (
    from_xml_to_dataframe,
    call_to_ecb_api_exchange_rate,
...
def test_from_xml_to_dataframe():
    ...
    assert exchange_rates.equals(
        result_expected_from_xml
    ), "Check xml is correctly parsed to df"
